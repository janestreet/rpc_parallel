(* OASIS_START *)
(* DO NOT EDIT (digest: 6c3abb945db02b0aae1d7428ae7dfd68) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights =
            ["(C) 2014 Jane Street Group LLC <opensource@janestreet.com>"];
          maintainers =
            ["Jane Street Group"; "LLC <opensource@janestreet.com>"];
          authors = ["Jane Street Group"; "LLC <opensource@janestreet.com>"];
          homepage = Some "https://github.com/janestreet/rpc_parallel";
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Parallel"; "Worker_id"; "Std"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "rpc_parallel";
                      lib_findlib_name = Some "core";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "rpc_parallel";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("core", None);
                           FindlibPackage ("async", None);
                           InternalLibrary "rpc_parallel_core";
                           FindlibPackage ("pa_ounit", None);
                           FindlibPackage ("pa_ounit.syntax", None);
                           FindlibPackage ("sexplib", None);
                           FindlibPackage ("sexplib.syntax", None);
                   ...
                   {
                      lib_modules = ["Map_reduce"; "Parallel"; "Std"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "rpc_parallel";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "timeouts.ml"});
               Executable
                 ({
                     cs_name = "test_zombies";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "test_zombies.ml"});
               Executable
                 ({
                     cs_name = "add_numbers";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "add_numbers.ml"});
               Executable
                 ({
                     cs_name = "copy_executable";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "copy_executable.ml"});
               Executable
                 ({
                     cs_name = "env_test";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "env_test.ml"});
               Executable
                 ({
                     cs_name = "run_exn";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "run_exn.ml"});
               Executable
                 ({
                     cs_name = "side_arg";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "side_arg.ml"});
               Executable
                 ({
                     cs_name = "simple";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "workers_as_masters.ml"
                   });
               Executable
                 ({
                     cs_name = "worker_binprot2";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "worker_binprot2.ml"});
               Executable
                 ({
                     cs_name = "worker_binprot";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "worker_binprot.ml"})
            ];
          plugins =
            [
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "R\198\2170\200+\194\r\195g\003\225\141\023\151$";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
