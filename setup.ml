(* OASIS_START *)
(* DO NOT EDIT (digest: d37ac458445f50b6b940c25ccfaedb31) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights =
            ["(C) 2014 Jane Street Capital LLC <opensource@janestreet.com>"];
          maintainers =
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Parallel"; "Worker"; "Std"];
                      lib_pack = true;
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\212\155\177\181\155\171\018\165\163\165l\226\168b\t\190";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
